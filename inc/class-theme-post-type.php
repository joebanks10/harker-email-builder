...
class Theme_Post_Type {
    ...
    private function register_post_type() {
        $labels = array(
            'name'               => _x( 'Themes', 'post type general name', 'hkr-email-builder-admin' ),
            'singular_name'      => _x( 'Theme', 'post type singular name', 'hkr-email-builder-admin' ),
            'menu_name'          => _x( 'Email Themes', 'admin menu', 'hkr-email-builder-admin' ),
            'name_admin_bar'     => _x( 'Theme', 'add new on admin bar', 'hkr-email-builder-admin' ),
            ...
            'edit_item'          => __( 'Edit Theme', 'hkr-email-builder-admin' ),
            'view_item'          => __( 'View Theme', 'hkr-email-builder-admin' ),
            'all_items'          => __( 'All Themes', 'hkr-email-builder-admin' ),
