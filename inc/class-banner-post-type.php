...
class Banner_Post_Type {
    ...
    private function register_post_type() {
        $labels = array(
            'name'               => _x( 'Email Banners', 'post type general name', 'hkr-email-builder-admin' ),
            'singular_name'      => _x( 'Email Banner', 'post type singular name', 'hkr-email-builder-admin' ),
            'menu_name'          => _x( 'Email Banners', 'admin menu', 'hkr-email-builder-admin' ),
            'name_admin_bar'     => _x( 'Email Banner', 'add new on admin bar', 'hkr-email-builder-admin' ),
            ...
            'edit_item'          => __( 'Edit Email Banner', 'hkr-email-builder-admin' ),
            'view_item'          => __( 'View Email Banner', 'hkr-email-builder-admin' ),
            'all_items'          => __( 'Banners', 'hkr-email-builder-admin' ),
